...
class HostGameFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val answer1 = view.findViewById<TextView>(R.id.hostAnswer1Text)
        val answer2 = view.findViewById<TextView>(R.id.hostAnswer2Text)
        val answer3 = view.findViewById<TextView>(R.id.hostAnswer3Text)
        val answer4 = view.findViewById<TextView>(R.id.hostAnswer4Text)
